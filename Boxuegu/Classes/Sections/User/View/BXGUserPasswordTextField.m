...
@interface BXGUserPasswordTextField()
...
@end
@implementation BXGUserPasswordTextField
...
//    [pswKeyBtn addSubview:pswKeyImageView];
    ...
    [pswKeyBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.centerY.equalTo(tagLabel);
        make.right.equalTo(pswKeyBtn.superview).offset(-15);

...
//};
//
//@interface BXGCoursePlayerVC () <DWVideoPlayerDelegate, UIGestureRecognizerDelegate,BXGNotificationDelegate>
...
//@end
//
//@implementation BXGCoursePlayerVC
...
//    
//    //    float proSec = CMTimeGetSeconds([self.player.player currentTime]);
//    //    float durSec =CMTimeGetSeconds(self.player.player.currentItem.duration);
...
//    [self saveHistoryWithVideoModel:videoModel isEnd:false];
//    
...
//    titleLabel.font = [RWFont fontWithName:@"PingFangSC-Semibold" size:13];
...
//    
//    currentTimeLabel.font = [RWFont systemFontOfSize:12];
...
//    durationTimeLabel.font = [RWFont systemFontOfSize:12];
...
//    selectSpeedBtn.titleLabel.font = [RWFont systemFontOfSize:14];
//    
...
//    selectVideoBtn.titleLabel.font = [RWFont systemFontOfSize:14];
//    
...
//    
//    // 判断是否被锁定
//    if((!videoModel.lock_status || [videoModel.lock_status integerValue] == 0) && !weakSelf.isOfflineVideo){
//        
...
//            self.changingVolume = self.systemVolume;
//        }
//    }
//    
//    return _volumeView;

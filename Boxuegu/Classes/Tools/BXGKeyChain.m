...
@implementation BXGKeyChain
+(NSString *)getDeviceIDInKeychain
{
    NSString *getUDIDInKeychain = (NSString *)[BXGKeyChain load:KEY_UDID_INSTEAD];
    ...
    if (!getUDIDInKeychain ||[getUDIDInKeychain isEqualToString:@""]||[getUDIDInKeychain isKindOfClass:[NSNull class]]) {
        ...
        [BXGKeyChain save:KEY_UDID_INSTEAD data:result];
        getUDIDInKeychain = (NSString *)[BXGKeyChain load:KEY_UDID_INSTEAD];
    }

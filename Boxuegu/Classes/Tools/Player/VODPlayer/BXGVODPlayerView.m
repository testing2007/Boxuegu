...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if(self) {
        ...
        NSString *ccUserId = [BXGUserCenter share].userModel.cc_user_id;
        NSString *ccAPIKey = [BXGUserCenter share].userModel.cc_api_key;
